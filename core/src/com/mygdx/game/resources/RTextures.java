...
public class RTextures {
    ...
    public static final Texture apple = new Texture("textures\\apple.png");
    public static final Texture watermellon = new Texture("textures\\watermellon.png");
    public static final Texture mindCloud = new Texture("textures\\mindcloud.png");
    public static final Texture jeludok = new Texture("textures\\jeludok.png");
    public static final Texture orange = new Texture("textures\\orange.png");
    public static final Texture banana = new Texture("textures\\banana.png");
    public static final Texture mm_bg = new Texture("textures\\mm_bg.png");
    ...
    public static final Texture heart = new Texture("textures\\heart.png");
    public static final Texture store_vitrine = new Texture("textures\\store_vitrine.png");
    public static final Texture back_arrow = new Texture("textures\\back_arrow.png");
